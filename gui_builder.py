...
class GUIBuilder:
    ...
    def _create_main_panel_widgets(app):
        ...
        ctk.CTkButton(app.main_frame, text="🎨 Criar Paleta de Cores", height=50, font=ctk.CTkFont(size=16, weight="bold"), command=app._handle_create_palette_button, fg_color=app.COLOR_PRIMARY_BUTTON2, hover_color=app.COLOR_PRIMARY_HOVER).grid(row=1, column=0, padx=0, pady=(2), sticky="ew")
        
        ctk.CTkButton(app.main_frame, text="↪️ Converter formato", height=50, font=ctk.CTkFont(size=16, weight="bold"), command=app._handle_create_palette_button, fg_color=app.COLOR_PRIMARY_BUTTON2, hover_color=app.COLOR_PRIMARY_HOVER).grid(row=2, column=0, padx=0, pady=(2), sticky="ew")
        ...
        app.tabview.grid(row=3, column=0, columnspan=2, sticky="nsew")
        ...
        app.preview_label.pack(padx=0, pady=0, expand=True, fill="both")
        ...
        app.log_textbox.pack(padx=0, pady=0, expand=True, fill="both")
        ...
        app.palette_preview_label = ctk.CTkLabel(palette_tab_frame, text="Selecione uma imagem para ver o preview", text_color=app.COLOR_TEXT)
        app.palette_preview_label.grid(row=0, column=0, sticky="nsew", padx=20, pady=(2))

        # Frame para a paleta de cores
        app.palette_frame = ctk.CTkFrame(palette_tab_frame, fg_color="transparent")
        app.palette_frame.grid(row=1, column=0, sticky="ew", padx=20, pady=2)
